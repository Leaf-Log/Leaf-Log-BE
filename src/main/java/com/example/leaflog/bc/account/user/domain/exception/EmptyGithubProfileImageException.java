...
public class EmptyGithubProfileImageException extends CustomException {

    public EmptyGithubProfileImageException(){
        super(ErrorCode.GITHUB_PROFILE_IMAGE_EMPTY);
    }
}
